...
import { MediaBenchmark } from './modules/reporting/entities/media-benchmark.entity';
      ...
      useFactory: (config: ConfigService) => {
        ...
        if (databaseUrl) {
          ...
          return {
            type: 'postgres',
            url: databaseUrl,
            entities: [User, Kol, KolPlatform, Campaign, CampaignKol, CampaignKolPost, Lead, MediaBenchmark],
