        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
            ...
            <div className="rounded-xl bg-gray-50 p-4 space-y-2 text-sm">
              <div className="flex flex-wrap gap-2">
                ...
                {kol.contentTags?.map((tag) => (
                  <span key={tag} className="rounded-full bg-gray-200 px-2.5 py-0.5 text-xs text-gray-600">
                    {tag}
                  </span>
                ))}
              </div>
          ...
          {record?.clientFeedback && (
            <div className={clsx(
              ...
              <p className={clsx('font-semibold', record.clientFeedback === 'Approved' ? 'text-green-700' : 'text-red-700')}>
                {record.clientFeedback === 'Approved' ? '✓ Client approved' : '✗ Client rejected'}
              </p>
              {record.clientComment && (
                <p className="mt-1 text-xs text-gray-600">"{record.clientComment}"</p>
              )}
            </div>
          )}
          ...
          <div className="rounded-xl bg-gray-50 p-4 space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400">Mark when negotiated fee has been paid</p>
              </div>
              <button
                type="button"
          ...
          {/* Meta */}
          {record && (
            <div className="rounded-lg bg-gray-50 p-3 text-xs text-gray-400 space-y-0.5">
              {record.assignedTo && (
